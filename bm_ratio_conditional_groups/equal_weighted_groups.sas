...
%do mon=52 %to 183;
  ...
  proc rank data=MVB1 out=MVB2 groups=5; var bmratio; ranks z2; run;
  proc sort data=MVB2; by z2; run;
  proc rank data=MVB2 out=MVB3 groups=5; var ivol; ranks z1; by z2; run;
  data MVB4; set MVB3; z=z2*5+z1+1; drop z1 z2 bmratio; run;
  ...
  set MVB6;
	...
	if z=21 then do r21=return; retain r21;z=31;return=return-r1;output;end;
	if z=22 then do z=32;return=return-r2;output;end;
    if z=23 then do z=33;return=return-r3;output;end;
	if z=24 then do z=34;return=return-r4;output;end;
	if z=25 then do r25=return;retain r25;
	    z=35;return=return-r5;output;z=30;return=r25-r21;output;
		z=36;return=return-r26;output;end;
  run;
