...
%do mon=52 %to 183;
  ...
  proc rank data=MVA1 out=MVA2 groups=5; var bmratio; ranks z2; run;
  proc sort data=MVA2; by z2; run;
  proc rank data=MVA2 out=MVA3 groups=5; var ivol; ranks z1; by z2; run;
  data MVA4; set MVA3; z=z2*5+z1+1; drop z1 z2 ivol bmratio; run;
  proc sort data=MVA4; by z; run;
  ...
  set MVA6;
	...
	if z=2 then do r2=return_vw; retain r2; end;
	if z=3 then do r3=return_vw; retain r3; end;
	if z=4 then do r4=return_vw; retain r4; end;
	if z=5 then do r5=return_vw; retain r5; 
        z=26;return_vw=r5-r1;r26=return_vw;retain r26;output;end;
	if z=6 then do r6=return_vw; retain r6; end;
    if z=10 then do z=27;return_vw=return_vw-r6;output;end;
    if z=11 then do r11=return_vw; retain r11; end;
    if z=15 then do z=28;return_vw=return_vw-r11;output;end;
	if z=16 then do r16=return_vw; retain r16; end;
	if z=20 then do z=29; return_vw=return_vw-r16; output;end;
	if z=21 then do r21=return_vw; retain r21;z=31;return_vw=return_vw-r1;output;end;
	if z=22 then do z=32;return_vw=return_vw-r2;output;end;
    if z=23 then do z=33;return_vw=return_vw-r3;output;end;
	if z=24 then do z=34;return_vw=return_vw-r4;output;end;
	if z=25 then do r25=return_vw;retain r25;
	    z=35;return_vw=return_vw-r5;output;z=30;return_vw=r25-r21;output;
		z=36;return_vw=return_vw-r26;output;end;
  run;
  data MVA8; set MVA7; drop r1 r2 r3 r4 r5 r6 r26 r11 r16 r21 r25; run;
