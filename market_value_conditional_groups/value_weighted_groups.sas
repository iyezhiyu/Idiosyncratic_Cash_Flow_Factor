...
%do mon=52 %to 183;
  ...
  proc rank data=MVA1 out=MVA2 groups=5; var Msmvosd; ranks z2; run;
  proc sort data=MVA2; by z2; run;
  proc rank data=MVA2 out=MVA3 groups=5; var ivol; ranks z1; by z2; run;
  data MVA4; set MVA3; z=z2*5+z1+1; drop z1 z2 ivol; run;
  ...
  set MVA6;
	...
	if z=21 then do r21=return_vw; retain r21; z=31;return_vw=r1-return_vw;output; end;
	if z=22 then do z=32;return_vw=r2-return_vw;output; end;
    if z=23 then do z=33;return_vw=r3-return_vw;output; end;
	if z=24 then do z=34;return_vw=r4-return_vw;output; end;
	if z=25 then do r25=return_vw;retain r25;
	    z=35;return_vw=r5-return_vw;output; z=30;return_vw=r25-r21;output;
		z=36;return_vw=r26-return_vw;output; end;
  run;
